...
import type { Announcement, NewAnnouncement, AnnouncementType } from "@/db/schema/announcements";
...
class AnnouncementService {
                ...
                async unpublishAnnouncement(id: string, userId: string): Promise<Announcement> {
                                const db = getDatabase();
