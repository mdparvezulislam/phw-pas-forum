        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-3">
            <div className="rounded-xl border border-border bg-card p-6 text-center">
              ...
              <p className="mt-1 text-sm text-muted-foreground">support@bhwpas.com</p>
            </div>
            <div className="rounded-xl border border-border bg-card p-6 text-center">
              <div className="mx-auto mb-3 flex h-10 w-10 items-center justify-center rounded-full bg-primary/10 text-primary">
              ...
              <p className="mt-1 text-sm text-muted-foreground">Visit our forums</p>
            </div>
            <div className="rounded-xl border border-border bg-card p-6 text-center">
              <div className="mx-auto mb-3 flex h-10 w-10 items-center justify-center rounded-full bg-primary/10 text-primary">
              ...
              <p className="mt-1 text-sm text-muted-foreground">partners@bhwpas.com</p>
            </div>
          </div>
